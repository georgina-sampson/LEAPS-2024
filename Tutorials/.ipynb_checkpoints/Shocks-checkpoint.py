...
param_dict = {
    ...
    "abundSaveFile": "Documents/LEAPS-2024/Tutorials/examples/test-output/shockstart.dat",
}
...
param_dict["abundLoadFile"]="Documents/LEAPS-2024/Tutorials/examples/test-output/shockstart.dat"
param_dict["outputFile"]="Documents/LEAPS-2024/Tutorials/examples/test-output/cshock.dat"


result=uclchem.model.cshock(shock_vel=40,param_dict=param_dict)
result,dissipation_time=result

phase2_df=uclchem.analysis.read_output_file("Documents/LEAPS-2024/Tutorials/examples/test-output/cshock.dat")

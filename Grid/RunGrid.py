...
# Stage 1
gridParameters = {'iDens':np.array([1e6,1e7,1e8]),
# gridParameters = {'iDens':np.array([1e3,1e4,1e5]),
...
# Hot Core
gridParameters.update({'fDens':np.array([1e6,1e7,1e8]),
                       'fTemp': np.array([50,100,300])})
tipo = 'hot core'

# C Shock
# gridParameters.update({'fDens':np.array([1e3,1e4,1e5]),
